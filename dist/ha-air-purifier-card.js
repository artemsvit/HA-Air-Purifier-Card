            ...
            ${"on"===i?At`
              <div class="speed-control">
                <ha-button-toggle-group>
                  ${["Silent","Low","Medium","High"].map((t=>At`
                    <ha-button-toggle
                      .selected=${$===t}
                      @click=${()=>this._handleSpeedClick(t)}
                      class="speed-button ${$===t?"active":""}"
                    >
