        ...
        <div class="content">
          <div class="pm25-section">
            <div class="pm25-circle ${"on"===i?"active":""}" style="--pm25-color: ${g}">
              ${this.config.show_animation?At`
                <div class="pm25-animation ${"on"===i?"active":""}"></div>
              `:""}
