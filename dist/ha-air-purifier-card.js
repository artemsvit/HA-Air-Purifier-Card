          ...
          ${"on"===s?At`
            <div class="mode-buttons">
              ${Object.entries(Jt).map((([t,e])=>At`
                <ha-button-toggle
                  .label=${t}
                  ?active=${C.toLowerCase()===e.toLowerCase()}
            ...
            <div class="info-grid">
              ${this.config.show_temperature?At`
                <div class="info-item">
                  ...
                  <span class="info-value">${g}°C</span>
